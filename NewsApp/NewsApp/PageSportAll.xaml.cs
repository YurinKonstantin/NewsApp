...
namespace NewsApp
{
	...
	public partial class PageSportAll : ContentPage
	{
		public PageSportAll ()
		{
			InitializeComponent ();
        ...
        public async Task zagruzka1(string titlestring)
        {
            ...
            try
            {
                ...
                {
                    List<RSSFeedItem> rSSFeedItems = await Task.Run(() => (MyComande.zagruzka1(new ClassIstochnik() { Urr = ClassURI.SportAll, Istochnik = "Lenta.ru" }, metrics.Width)));
                Col1.Clear();
