...
namespace NewsApp
{
	...
	public partial class PageRusObshestvo : ContentPage
	{
            ...
            try
            {
                ...
                if (current == NetworkAccess.Internet)
                {
                    ...
                    int d = 0;
                            ...
                            rSSFeedItems = await Task.Run(() => (MyComande.zagruzka1(new ClassIstochnik() { Urr = ClassURI.RusObshestvo, Istochnik = "Lenta.ru" }, metrics.Width)));
