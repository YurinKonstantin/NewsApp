            ...
            try
            {
                ...
                if (current == NetworkAccess.Internet)
                {
                    ...
                    int d = 0;
                            ...
                            rSSFeedItems = await Task.Run(() => (MyComande.zagruzka1(new ClassIstochnik() { Urr = ClassURI.RusCP, Istochnik = "Lenta.ru" }, metrics.Width)));
